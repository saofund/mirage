...
def film():
    ...
    record_build(
        stages, "interior_build", captions=captions,
        view=(float(os.environ.get("ANIM_YAW", -0.78)),    # the open +x,-y corner, looking in
              float(os.environ.get("ANIM_PITCH", 0.52)),
              float(os.environ.get("ANIM_DIST", 7.8))),
