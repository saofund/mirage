...
# was not blue enough, the 33,000-pixel mask said its cast was -0.014, and following the ten
# took the mask to -0.096 and made it the worst item on the card. Where a mask is aligned --
# this one sits at 8.6 px -- it outvotes any number of points placed by hand.
...
HUMP      = mat((0.230, 0.230, 0.236), 0.0, 0.70)
...
NAVY      = mat((0.205, 0.225, 0.38), 0.0, 0.44)
